...
import { EntityManager, QueryOrder, RequiredEntityData, wrap } from '@mikro-orm/core';
...
export class ArticleService {
  ...
  async create(userId: number, dto: CreateArticleDto) {
    ...
    var tags: RequiredEntityData<Tag>[] = []
    dto.tagList.forEach( (tag) => {tags.push(new Tag(tag))})
